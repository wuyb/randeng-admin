    ...
    children: [
      {
        path: 'index',
        name: 'Fundraising',
        component: () => import('@/views/fundraising/index'),
        meta: { title: '募捐', icon: 'form' }
      }
    ]
  },
